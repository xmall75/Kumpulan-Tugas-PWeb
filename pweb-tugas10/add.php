                  ...
                  <h2>Add new Records</h2>
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="transac.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Last Name" name="kelamin">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Middle Name" name="alamat">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="Address" name="email">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             <label for="nik">NIK</label>
                              <input class="form-control" rows="3"  name="nik">
                            </div>  
