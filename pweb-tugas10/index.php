                  ...
                  <h2>Isikan identitas</h2>
                      ...
                      <form role="form" method="post" action="transac.php?action=add">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control" placeholder="Jenis Kelamin" name="kelamin">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <label for="Alamat">Contact</label>
                              <input class="form-control" placeholder="Contact" name="contact">
                            </div> 
                            <div class="form-group">
                             <label for="nik">NIK</label>
                              <input class="form-control" rows="3" placeholder="NIK" name="nik">
                            </div>  
                      ...
                      <a href="list.php">
                                <button class="btn btn-default">List siswa terdaftar</button>
                            </a>
                    </div>
                </div>
